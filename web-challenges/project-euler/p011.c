...
static const unsigned short grid[ROWS][COLS] = {
...
int main(void) {
	...
	unsigned int maxDown = down();
	unsigned int maxRightDiag = rightDiag();
	unsigned int maxLeftDiag = leftDiag();
	printf("maxRight:\t%d\nmaxDown:\t%d\nmaxRightDiag:\t%d\nmaxLeftDiag:\t%d\n",
		maxRight, maxDown, maxRightDiag, maxLeftDiag);
	return 0;
}
